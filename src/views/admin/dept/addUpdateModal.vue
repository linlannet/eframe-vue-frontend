    ...
    <a-modal v-model:visible="pageData.visible" width="60%" :title="pageData.title" :destroyOnClose="true" @ok="clickModalOk" @cancel="handleModalCancel">
      <a-form ref="deptAddUpdateFormRef" name="deptAddUpdateForm" :model="deptAddUpdateForm.data" :labelCol="{ span: 8 }" :wrapperCol="{ span: 14 }">
        <a-row :gutter="24">
          ...
          <a-col span="12">
            <a-form-item name="name" label="部门名称" :rules="[{ required: true, message: '部门名称不能为空！' }]">
              <a-input v-model:value="deptAddUpdateForm.data.name" :maxlength="30" placeholder="请填写部门名称"></a-input>
            </a-form-item>
          </a-col>
          <a-col span="12">
            <a-form-item name="priority" label="显示顺序" :rules="[{ required: true, message: '显示顺序不能为空！' }]">
              <a-input v-model:value="deptAddUpdateForm.data.priority" :maxlength="30" placeholder="请填写显示顺序"></a-input>
            </a-form-item>
          </a-col>
          <a-col span="12">
            <a-form-item name="organLeader" label="负责人" :rules="[{}]">
              <a-input v-model:value="deptAddUpdateForm.data.organLeader" :maxlength="30" placeholder="请填写负责人"></a-input>
            </a-form-item>
          </a-col>
          <a-col span="12">
            <a-form-item name="organLeaderMobile" label="联系电话" :rules="[{}]">
              <a-input v-model:value="deptAddUpdateForm.data.organLeaderMobile" :maxlength="30" placeholder="请填写联系电话"></a-input>
            </a-form-item>
          </a-col>
          <a-col span="12">
...
import { getDept, addDept, updateDept } from '@/api/admin/dept';
...
const resetDeptAddUpdateForm = () => {
  LocalUtil.resetFormFieldsToEmpty(deptAddUpdateForm.data);
};
